		...
		<div class="header_top-sec">
			...
			<div class="top_left">
				<ul>
					...
					<li class="top_link"><a href="{{ url ("/login") }}"login>My Account</a></li>					
				</ul>
			</div>
...
<div class="header-top">
	 <div class="header-bottom">
		 <div class="container">			
			 ...
			 <div class="top-nav">
				<ul class="memenu skyblue"><li class="active">
					<a href="{{ url ("/beranda") }}">Home</a></li>
							...
							<div class="row">
								<div class="col1 me-one">
									...
									<ul>
										...
										<li><a href="{{ url ("/produk") }}">Men</a></li>
										<li><a href="{{ url ("/produk") }}">Women</a></li>
										<li><a href="{{ url ("/produk") }}">Accessories</a></li>
										<li><a href="{{ url ("/produk") }}">Kids</a></li>
										<li><a href="{{ url ("/produk") }}">login</a></li>
										<li><a href="{{ url ("/produk") }}">Brands</a></li>
										<li><a href="{{ url ("/produk") }}">My Shopping Bag</a></li>
									</ul>
								</div>
								<div class="col1 me-one">
									<h4>Style Zone</h4>
									<ul>
										...
										<li><a href="{{ url ("/produk") }}">Kids</a></li>
										<li><a href="{{ url ("/produk") }}">Accessories</a></li>
										<li><a href="{{ url ("/produk") }}">Style Videos</a></li>
									</ul>	
								</div>
								<div class="col1 me-one">
									<h4>Popular Brands</h4>
									<ul>
										<li><a href="{{ url ("/produk") }}">Levis</a></li>
										<li><a href="{{ url ("/produk") }}">Persol</a></li>
										<li><a href="{{ url ("/produk") }}">Nike</a></li>
										<li><a href="{{ url ("/produk") }}">Edwin</a></li>
										<li><a href="{{ url ("/produk") }}">New Balance</a></li>
										<li><a href="{{ url ("/produk") }}">Jack & Jones</a></li>
										<li><a href="{{ url ("/produk") }}">Paul Smith</a></li>
										<li><a href="{{ url ("/produk") }}">Ray-Ban</a></li>
										<li><a href="{{ url ("/produk") }}">Wood Wood</a></li>
									</ul>	
								</div>
							</div>
						</div>
